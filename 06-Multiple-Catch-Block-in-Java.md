...
- If a broad exception type like Exception is placed first, it may catch all others and prevent specific handlers from running.
...
- A Scanner object reads data from the user.
